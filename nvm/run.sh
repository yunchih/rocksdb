...
if [ -z "$RBENCH_BENCHMARKS" ]; then
	RBENCH_BENCHMARKS="fillseq,readwhilewriting,readseq,readrandom,readrandomwriterandom"
fi
...
nvm)
	...
	RBENCH_ENV_URI="nvm://punits:${NVM_BGN}-${NVM_END}@${RBENCH_MAPPING}-${RBENCH_HEIGHT}%${RBENCH_DEV_NAME}${DB_ROOT}/${RBENCH_DEV_NAME}_${NVM_BGN}_${NVM_END}_${RBENCH_MAPPING}_${RBENCH_HEIGHT}.meta"
...
RBENCH_BIN="../db_bench"
RBENCH_NUM=10000
RBENCH_VALUE_SIZE=$((3072 * KB))
RBENCH_BLOCK_SIZE=$((96 * KB))
RBENCH_BLOOM_BITS=10
RBENCH_CACHE_SIZE=$((96 * KB))
RBENCH_RANDOM_ACCESS_MAX_BUFFER_SIZE=$((24 * MB))
RBENCH_WRITABLE_FILE_MAX_BUFFER_SIZE=$((24 * MB))
RBENCH_WRITE_BUFFER_SIZE=$((24 * MB))
RBENCH_MAX_WRITE_BUFFER_NUMBER=64
RBENCH_MIN_WRITE_BUFFER_NUMBER_TO_MERGE=2
RBENCH_TARGET_FILE_SIZE_MULTIPLIER=1
RBENCH_TARGET_FILE_SIZE_BASE=$((768 * MB))
RBENCH_MAX_BYTES_FOR_LEVEL_BASE=$((768 * MB))
...
RBENCH_LEVEL0_SLOWDOWN_WRITES_TRIGGER=16
RBENCH_LEVEL0_STOP_WRITES_TRIGGER=24
RBENCH_MAX_BACKGROUND_COMPACTIONS=40
RBENCH_MIN_LEVEL_TO_COMPRESS=2
RBENCH_MMAP_READ=0
RBENCH_NUM_LEVELS=6
RBENCH_OPEN_FILES=500000
RBENCH_STATISTICS=0
RBENCH_STATS_INTERVAL=1000000000
